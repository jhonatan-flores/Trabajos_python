...
def cambio_tema(ventana,colores):
    if ventana.tema_oscuro:
        ...
        ventana.boton_tema.configure(text="Modo Claro \uf185", relief=SUNKEN,bg=colores.COLOR_BOTONES_ESPECIALES_LIGHT)
    else:
        ...
        ventana.boton_tema.configure(text="Modo Oscuro \uf186", relief=SUNKEN,bg=colores.COLOR_BOTONES_ESPECIALES_NEGRO)
